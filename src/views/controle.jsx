...
function Controle() {
    ...
    useEffect(() => {
        function loadTransacoes() {
            const trans =
                localStorage.getItem('transacoes') !== null ? JSON.parse(localStorage.getItem('transacoes')) : [];
    ...
    function handleSubmit(event) {
        ...
        var trans = localStorage.getItem('transacoes') !== null ? JSON.parse(localStorage.getItem('transacoes')) : [];
